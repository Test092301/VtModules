...
const showTextures = true; // Toggle this to hide/show textures
...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className={`relative pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-br from-primary to-primary-dark text-white overflow-hidden ${
        showTextures ? "bg-texture" : ""
      }`}
    >
      {showTextures && (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            Delivering Soon, world-class camera modules with state-of-the-art facilities, setting new standards for innovation and quality in Indian manufacturing.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
